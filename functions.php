...
function twentyten_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'twentyten' ) . '</a>';
}
...
add_filter( 'avatar_defaults', 'zombie' );  
  
function zombie ($avatar_defaults) {  
    $myavatar = get_bloginfo('template_directory') . '/images/zombie.jpg';  
    $avatar_defaults[$myavatar] = "Zombie";  
    return $avatar_defaults;  
} 
